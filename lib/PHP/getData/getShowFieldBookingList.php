...
header("Access-ontrol-Allow-Origin: *");
    ...
    if($_GET['isAdd']=='true'){
        $std_id =$_GET['std_id'];
    $result = mysqli_query($link, "SELECT sub_stadium.substd_id,
    sub_stadium.substd_name,
    booking_time.bkt_id,
...
ORDER BY sub_stadium.substd_id,booking_time.bkt_id;
         ");
